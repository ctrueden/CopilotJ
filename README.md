...
[![User Manual](https://img.shields.io/badge/User%20Manual-docs-green?style=flat-square)](https://copilotj.chat/config)
...
Learn more on the [Project Page](https://copilotj.chat/), follow the [User Manual](https://copilotj.chat/config) to get started, or watch the [Video Demos](https://www.youtube.com/playlist?list=PLXIvvwpNOx3cg0OSE6mh-BxzaO0pMEVpb) to see CopilotJ in action.
...
For full installation and configuration instructions — including environment setup, API key configuration, and how to run each component — please refer to the [User Manual](https://copilotj.chat/config).
